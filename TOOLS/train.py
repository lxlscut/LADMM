...
def train_clustering(args,device):
    if args.dataset == 'Houston':
        ...
        dataset = Load_my_Dataset("/home/xianlli/dataset/HSI/trento/Trento.mat",
                                  "/home/xianlli/dataset/HSI/trento/Trento_gt.mat", patch_size=args.patch_size,
                                  device=device)

    elif args.dataset == 'Pavia':
        dataset = Load_my_Dataset("/home/xianlli/dataset/HSI/pavia/PaviaU.mat",
                                  "/home/xianlli/dataset/HSI/pavia/PaviaU_gt.mat", patch_size=args.patch_size,
                                  device=device)
    ...
    student.train_stage_2(train_loader=train_loader, teacher=teacher, dataset=dataset, epochs=400)
