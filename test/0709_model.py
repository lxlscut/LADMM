...
class L_ADMM(nn.Module):
    def __init__(self, args):
        ...
        # first stage:
        self.stopping_1 = EarlyStoppingCurveWithSmooth(min_delta=1e-3)
        # second stage:
        self.stopping_2 = EarlyStoppingCurveWithSmooth(min_delta=1e-3)

        self.stopping_pre = EarlyStoppingCurveWithSmooth(min_delta=1e-3)
    ...
    def pretrain_ae(self, train_loader, num_epochs=10, lr=0.001):
        ...
        for epoch in range(num_epochs):
            ...
            for batch_idx, (data, _, _) in enumerate(train_loader):
                ...
                optimizer.step()
                total_loss += loss
            # if self.stopping_pre(total_loss/(batch_idx+1)):
            #     break
    ...
    def train(self, train_loader: object, dataset: object, epochs) -> object:
        for epoch in range(epochs):
            if not self.stopping_1.early_stop:
